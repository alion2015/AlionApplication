...
public class FoldView extends View {
    ...
    private Path mRegionCurrent;// 当前页区域，其实就是控件的大小
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mViewWidth = w;
        mViewHeight = h;
        Log.d("alionlog", "onSizeChanged: w="+w+"===H==="+h);
        ...
        // 计算当前页区域
        mRegionCurrent.addRect(new RectF(0, 0, mViewWidth, mViewHeight),Path.Direction.CCW);
    }
    ...
    private void drawBitmaps(Canvas canvas) {
       ...
       /* *//*
         * 定义区域
         *//*
        Path regionFold = null;
        Path regionNext = null;
